...
The mean and the median for total number of steps per day are **`r formatC(mean_daily_steps, format="d", big.mark=",")`** and **`r formatC(median_daily_steps, format="d", big.mark=",")`**
...
```
The total number of missing values is **`r NA_nr`**.
...
The mean and median of the total daily steps with replacement value for NAs in data are **`r formatC(new_mean_daily_steps_, format="d", big.mark=",")`** and **`r formatC(new_median_daily_steps, format="d", big.mark=",")`**, respectively. This compares to **`r formatC(mean_daily_steps, format="d", big.mark=",")`** and **`r formatC(median_daily_steps, format="d", big.mark=",")`** for data without missing values, which are fairly close. 
